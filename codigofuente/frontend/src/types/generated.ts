...
export type Producto = { id: string; codigo_interno: string; nombre: string; descripcion: string | null; categoria_id: number | null; unidad_base_id: number; ubicacion: string | null; temperatura_almacenamiento: string | null; requiere_cadena_frio: boolean; dias_estabilidad_abierto: number | null; clase_riesgo: string | null; fabricante: string | null; deleted_at: string | null; activo: boolean; control_lote: ControlLote; estado_catalogo: EstadoCatalogo; origen_registro: OrigenRegistro; version: number; created_at: string; updated_at: string; imagen_url: string | null; mpn: string | null; alias_unidad_clinica: string | null; es_kit: boolean; stock_minimo_global: string; codigo_loinc_cpt: string | null; es_cenabas: boolean }
