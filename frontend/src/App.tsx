...
const OrdenCompraDetallePage = lazy(
  () => import("@/pages/ordenes-compra/detalle"),
);
              ...
              <Routes>
                ...
                <Route element={<AppLayout />}>
                  ...
                  <Route
                    ...
                    element={<OrdenCompraDetallePage />}
                  />
                  <Route
                    path="/creador-productos"
                    element={<CreadorProductosPage />}
                  />
                  <Route
                    path="/configuracion"
