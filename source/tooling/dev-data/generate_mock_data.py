...
# Target SQL file is always colocated with this generator.
sql_file = Path(__file__).with_name("seed_dev.sql")
...
# Start transaction with an explicit destructive-development warning.
add_line("-- DEV-ONLY: destructive seed; apply only through source/tooling/apply-dev-seed.sh")
add_line("-- Never apply this file to a production or remote database.")
add_line("BEGIN;")
