...
export type UpdateConfiguracion = Partial<Omit<Configuracion, 'logo_base64'>> & {
  logo_base64?: string | null
}
...
export async function actualizarConfiguracion(payload: UpdateConfiguracion): Promise<Configuracion> {
