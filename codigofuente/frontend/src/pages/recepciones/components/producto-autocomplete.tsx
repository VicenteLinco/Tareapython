    ...
    canShowInitialList || canSearch
      ? productos
          ...
          .filter((p) => {
            ...
            return (
              normalizedNombre.includes(normalizedQ) ||
              normalizedCodigo.includes(normalizedQ)
            );
          })
          .slice(0, 8)
      : [];
          ...
          {suggestions.length === 0 ? (
            ...
            suggestions.map((p, i) => (
              ...
              >
                <ProductoImage
                  src={
                    (p as Producto & { imagen_url?: string | null }).imagen_url
                  }
                  size="sm"
                />
                ...
                <span className="text-xs opacity-50 font-mono flex-shrink-0">
                  {p.codigo_interno}
                </span>
              </div>
            ))
