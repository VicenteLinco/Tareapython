...
export default function CategoriasTab() {
  ...
  const createMut = useMutation({
    mutationFn: (data: { nombre: string; descripcion?: string | null }) =>
  ...
  const formJsx = (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="form-control">
        <label className="label">
          <span className="label-text text-sm font-medium">Descripcion</span>
        </label>
        <input
          type="text"
          className="input input-bordered input-sm h-9"
  ...
  return (
    <div className="space-y-4">
      ...
      <Dialog
        ...
        onClose={closeForm}
        title={formMode === "crear" ? "Nueva categoria" : "Editar categoria"}
      >
        {formJsx}
      </Dialog>
