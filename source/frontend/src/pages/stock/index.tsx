...
import {
  ...
  useCategorias,
  useProveedores,
} from "@/hooks/dominio/useCatalogos";
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-3">
            ...
            {estado !== "todos" && (
              <Badge
                variant="secondary"
                className="bg-primary/10 text-primary border-primary/20 gap-1 px-3 py-1 rounded-full text-[10px] font-bold"
              >
                {estado.toUpperCase()}
                <button
          ...
          <p className="text-sm text-base-content/50">
            {estado !== "todos"
              ? "Mostrando items que requieren atención prioritaria"
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
            className="h-9 rounded-xl border-base-300"
          ...
          {usuario?.rol === "admin" && (
            <Button
              ...
              onClick={() => navigate("/creador-productos?nuevo=true")}
            >
      ...
      <FilterBar
        ...
        chips={[
          ...
          },
          {
            label: "Agotado",
            value: "agotado",
            active: estado === "agotado",
            onClick: () =>
              setEstado(estado === "agotado" ? "todos" : "agotado"),
          },
          {
            label: "Vencido",
            value: "vencido",
            ...
            onClick: () =>
              setEstado(estado === "vencido" ? "todos" : "vencido"),
          },
          {
            label: "Por vencer",
            value: "vence_pronto",
            active: estado === "vence_pronto",
            onClick: () =>
              setEstado(estado === "vence_pronto" ? "todos" : "vence_pronto"),
          },
          {
            label: "Normal",
            value: "normal",
            ...
            <div className="flex bg-base-200 p-1 rounded-lg">
              <button
                className={cn(
                  ...
                  view === "list" ? "bg-base-100 shadow-sm" : "opacity-40",
                )}
              ...
              <button
                className={cn(
                  "p-1 rounded-md transition-all",
                  view === "grid" ? "bg-base-100 shadow-sm" : "opacity-40",
                )}
