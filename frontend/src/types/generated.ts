...
export type EstadoOrdenCompra =
  ...
  | "recibida_total"
  | "cancelada";
export type EstadoConteoSesion =
  | "borrador"
  | "en_progreso"
  | "confirmado"
  | "cancelado";
...
export type UpdateArea = {
  ...
  conteo_frecuencia_dias: number | null;
  version: number;
};
export type ProductoAreaRow = {
  id: string;
  codigo_interno: string;
  nombre: string;
...
export type UpdateUnidadBasica = {
  nombre: string | null;
...
export type EnvioProveedorView = {
  proveedor_id: number;
  proveedor_nombre: string;
  estado: EstadoEnvioProveedor;
...
export type SolicitudResumen = {
  ...
  proveedores_nombres: string | null;
};
export type SolicitudDetalle = {
  ...
  metodo_envio: string | null;
  items: SolicitudDetalleItem[];
  envios: EnvioProveedorView[];
  proveedores_resumen: ProveedorResumen[];
};
export type SolicitudDetalleItem = {
  producto_id: string;
  proveedor_id: number | null;
  producto_nombre: string;
  cantidad_sugerida: string;
...
export type DescarteResponse = {
  grupo_movimiento: string;
  movimientos: MovimientoGenerado[];
};
export type MovimientoGenerado = {
  id: string;
  numero_documento: string;
  cantidad: string;
  cantidad_resultante: string;
};
export type RecepcionQuery = {
  proveedor_id: number | null;
  estado: string | null;
  desde: string | null;
  hasta: string | null;
  ...
  solo_con_foto: boolean | null;
};
export type PaginatedRecepciones = {
...
export type CreateRecepcion = {
  ...
  solicitud_id: string | null;
  detalle: DetalleRecepcionInput[];
};
export type DetalleRecepcionInput = {
  producto_id: string;
  /**
...
export type RecepcionReconciliacionRow = {
  id: string;
  recepcion_id: string;
  solicitud_id: string;
  producto_id: string;
