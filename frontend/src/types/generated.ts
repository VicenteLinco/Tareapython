...
export type Producto = { id: string; codigo_interno: string; nombre: string; descripcion: string | null; categoria_id: number | null; unidad_base_id: number; ubicacion: string | null; temperatura_almacenamiento: string | null; requiere_cadena_frio: boolean; dias_estabilidad_abierto: number | null; clase_riesgo: string | null; deleted_at: string | null; activo: boolean; version: number; created_at: string; updated_at: string; proveedor_id: number | null; sku: string | null; precio_unidad: string | null; imagen_url: string | null; pres_nombre: string | null; pres_nombre_plural: string | null; pres_factor: string | null; pres_codigo_barras: string | null; pres_gtin: string | null; pres_gs1_habilitado: boolean }
export type Presentacion = { id: number; producto_id: string; nombre: string; nombre_plural: string; factor_conversion: string; codigo_barras: string | null; gtin: string | null; gs1_habilitado: boolean; activa: boolean; version: number; created_at: string; sku: string | null }
export type Lote = { id: string; producto_id: string; proveedor_id: number | null; numero_lote: string; fecha_vencimiento: string; costo_unitario: string | null; presentacion_id: number | null; recepcion_id: string | null; fecha_fabricacion: string | null; created_at: string }
