 ...
 */
export function MetricTooltip({ text, className, size = 'md', position = 'top' }: MetricTooltipProps) {
  ...
  return (
    <span
      ...
      data-tip={text}
    >
      <HelpCircle className={cn(iconClass, 'text-base-content/30 hover:text-base-content/60 transition-colors')} />
    </span>
  )
}
