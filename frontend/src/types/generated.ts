...
export type Usuario = { id: string; nombre: string; email: string; whatsapp_phone: string | null; rol: string; activo: boolean; version: number; created_at: string; updated_at: string }
