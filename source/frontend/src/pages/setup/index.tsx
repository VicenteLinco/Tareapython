...
export default function SetupPage() {
  ...
  const [resultadoStock, setResultadoStock] = useState<ImportResult | null>(
    null,
  );
    ...
    <div className="max-w-2xl mx-auto relative">
      ...
      <div className="mb-8">
        ...
        <p className="text-base-content/60 text-sm mt-1">
          Importa el catálogo de productos y el stock inicial desde archivos
          CSV.
        </p>
      </div>
      ...
      {paso !== "bienvenida" && (
        <ul className="steps steps-horizontal w-full mb-8">
          {PASOS.map((p) => (
            <li
              key={p.id}
              className={`step ${pasoIndex(paso) >= pasoIndex(p.id) ? "step-primary" : ""}`}
            >
              {p.label}
            </li>
          ))}
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="font-semibold text-lg">
                  Asistente de carga inicial
                </h2>
                <p className="text-sm text-base-content/60 mt-1">
                  Este proceso importará todos los insumos del laboratorio en
                  dos pasos:
                </p>
                <ol className="list-decimal list-inside text-sm text-base-content/70 mt-3 space-y-1">
                  <li>
                    Catálogo de productos (nombre, categoría, unidad,
                    presentaciones)
                  </li>
                  <li>
                    Stock inicial (lotes, fechas de vencimiento, cantidades por
                    área)
                  </li>
                </ol>
              </div>
            ...
            {estado && estado.productos_cargados > 0 && (
              <div className="alert alert-warning py-2">
                ...
                <span className="text-sm">
                  Ya hay <strong>{estado.productos_cargados}</strong>{" "}
                  {productoCargadoLabel(estado.productos_cargados)}. Puedes
                  continuar importando o ir directo al paso de stock.
                </span>
              </div>
            )}
            ...
            <div className="p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-50">
                    Usa el nuevo asistente interactivo 2026
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 bg-base-200/50 rounded-3xl border border-base-300 border-dashed text-center">
                <p className="text-sm font-medium mb-6 opacity-60">
                  Sube cualquier archivo CSV y el sistema te ayudará a mapear
                  tus columnas automáticamente.
                </p>
                <button
        ...
        <div className="card bg-base-100 border border-base-200 shadow-sm">
          <div className="card-body gap-5">
            <div>
              ...
              <p className="text-sm text-base-content/60 mt-1">
                Usa el nombre o código interno del producto. La fecha acepta
                YYYY-MM-DD o DD/MM/YYYY.
              </p>
            </div>

            <div className="bg-base-200 rounded-lg p-3 text-xs font-mono text-base-content/70 overflow-x-auto">
              producto_nombre_o_codigo, numero_lote, fecha_vencimiento, area,
          ...
          <div className="card-body gap-4">
            ...
            {resultadoStock.errores > 0 && (
              <div className="alert alert-info py-2 text-sm">
                <AlertTriangle className="w-4 h-4" />
                Puedes corregir los errores y volver a subir. El stock existente
                no se duplica.
              </div>
            )}
          ...
          <div className="card-body gap-5">
              ...
              <div className="stats stats-vertical shadow-none border border-base-200 rounded-xl w-full">
                <div className="stat py-3">
                  ...
                  <div className="stat-desc">
                    {resumen.presentaciones} presentaciones
                  </div>
                </div>
                <div className="stat py-3">
                  <div className="stat-figure text-secondary">
                  ...
                  <div className="stat-desc">
                    {resumen.stock_registros} registros con stock
                  </div>
                </div>
                <div className="stat py-3">
                  ...
                  <div className="stat-value text-xl">
                    {resumen.areas_con_stock}
                  </div>
                  <div className="stat-desc">
                    {resumen.categorias_creadas} categorías
                  </div>
                </div>
              </div>
            ) : (
            ...
            <div className="alert alert-warning py-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-base-content/70 mt-0.5">
                  Una vez finalizado, no podrás usar este asistente de carga
                  masiva. Las modificaciones deberán hacerse una a una desde el
                  catálogo.
                </p>
              </div>
            </div>
            ...
            <div className="card-actions justify-between">
              <button
                className="btn btn-ghost btn-sm"
                onClick={() =>
                  setPaso(resultadoStock ? "resultado-stock" : "stock")
                }
              >
                Atrás
              </button>
