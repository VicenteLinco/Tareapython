...
export const stockKeys = {
  ...
  area: (areaId: number, params?: object) => [...stockKeys.all, 'area', areaId, params] as const,
}
...
export const solicitudesKeys = {
  ...
  list: (filters?: object) => [...solicitudesKeys.all, 'list', filters] as const,
  detail: (id: string) => [...solicitudesKeys.all, id] as const,
  borrador: () => [...solicitudesKeys.all, 'borrador'] as const,
  recomendaciones: (params?: object) => [...solicitudesKeys.all, 'recomendaciones', params] as const,
}
...
export const catalogosKeys = {
  ...
  productos: {
    ...
    presentaciones: (productoId: string) => ['productos', productoId, 'presentaciones'] as const,
  },
}
...
export const movimientosKeys = {
  ...
  list: (filters?: object) => [...movimientosKeys.all, 'list', filters] as const,
  detail: (id: string) => [...movimientosKeys.all, id] as const,
  tendencias: (params?: object) => [...movimientosKeys.all, 'tendencias', params] as const,
}
