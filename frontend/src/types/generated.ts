...
export type ItemRecomendado = { producto_id: string; producto_nombre: string; codigo_proveedor: string | null; codigo_maestro: string | null; proveedor_id: number | null; proveedor_nombre: string | null; lead_time: number; autonomia_dias: number | null; nivel_urgencia: string; stock_actual: string; stock_minimo: string; consumo_diario_30d: string; cantidad_sugerida_base: string; presentacion_id: number | null; presentacion_nombre: string | null; presentacion_nombre_plural: string | null; factor_conversion: string | null; cantidad_sugerida_presentacion: string | null; precio_ultima_recepcion: string | null; unidad_base: string; unidad_base_plural: string | null; solicitudes_pendientes: number; imagen_url: string | null }
...
export type SolicitudResumen = { id: string; numero_documento: string; fecha_creacion: string; estado: string; usuario_nombre: string; items_count: number; nota_revision: string | null }
export type SolicitudDetalle = { id: string; numero_documento: string; fecha_creacion: string; estado: string; usuario_nombre: string; nota: string | null; nota_revision: string | null; fecha_revision: string | null; revisado_por_nombre: string | null; items: SolicitudDetalleItem[] }
...
export type MovimientoGenerado = { id: number; numero_documento: string; cantidad: string; cantidad_resultante: string }
