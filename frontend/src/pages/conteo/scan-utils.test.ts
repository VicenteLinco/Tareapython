...
function pres(productoId: string, opts: { gtin?: string; codigo_barras?: string }): Presentacion {
  return { producto_id: productoId, gtin: opts.gtin ?? null, codigo_barras: opts.codigo_barras ?? null } as unknown as Presentacion
}
