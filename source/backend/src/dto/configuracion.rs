...
pub struct ConfiguracionResponse {
    ...
    pub ia_api_key_groq: String,
    pub ia_api_key_mistral: String,
    pub ia_api_url_groq: String,
    pub ia_api_url_mistral: String,
    pub ia_modelos_configurados: String,
    pub vencimiento_alerta_activa: bool,
    pub vencimiento_vida_util_minima_dias: i32,
    pub vencimiento_margen_tolerancia_pct: i32,
    pub quarantine_default: bool,
    pub favicon_base64: Option<String>,
    pub login_bg_color: Option<String>,
}
...
pub struct UpdateConfiguracion {
    ...
    pub ia_api_key_groq: Option<String>,
    pub ia_api_key_mistral: Option<String>,
    pub ia_api_url_groq: Option<String>,
    pub ia_api_url_mistral: Option<String>,
    pub ia_modelos_configurados: Option<String>,
    pub favicon_base64: Option<String>,
    pub login_bg_color: Option<String>,
    ...
    pub quarantine_default: Option<bool>,
}
