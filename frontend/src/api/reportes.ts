...
export const reportesApi = {
  ...
  consumoCalendario: (params: ReporteParams) =>
    api.get<ConsumoCalendarioRow[]>('/reportes/consumo-calendario', { params }).then((r) => r.data),

  consumoProductos: (params: ReporteParams) =>
    api.get<ConsumoProductoRow[]>('/reportes/consumo-productos', { params }).then((r) => r.data),
