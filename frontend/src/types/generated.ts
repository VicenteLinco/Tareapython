...
export type SolicitudResumen = { id: string; numero_documento: string; fecha_creacion: string; estado: string; usuario_nombre: string; items_count: number; fecha_envio: string | null; fecha_cierre: string | null }
export type SolicitudDetalle = { id: string; numero_documento: string; fecha_creacion: string; estado: string; usuario_nombre: string; nota: string | null; fecha_envio: string | null; fecha_cierre: string | null; motivo_cierre: string | null; metodo_envio: string | null; items: SolicitudDetalleItem[] }
export type SolicitudDetalleItem = { producto_id: string; producto_nombre: string; cantidad_sugerida: string; unidad: string; unidad_plural: string | null; codigo_proveedor: string | null; codigo_maestro: string | null; proveedor_nombre: string | null; presentacion_nombre: string | null; presentacion_nombre_plural: string | null; factor_conversion: string | null; precio_unitario: string | null; presentacion_id: number | null; cantidad_presentaciones: string | null; imagen_url: string | null; horizonte_dias: number | null; horizonte_sugerido: number | null; horizonte_razon: string | null }
