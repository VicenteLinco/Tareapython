...
export async function buscarProducto(codigo: string): Promise<Producto> {
  const { data } = await api.get<Producto>("/productos/scan", {
    params: { codigo },
  });
  return data;
}
...
export async function reactivarProducto(id: string): Promise<ProductoDetalle> {
  const { data } = await api.post<ProductoDetalle>(
...
export async function listarPresentaciones(
  ...
  const { data } = await api.get<Presentacion[]>(
...
export async function crearPresentacion(
  ...
  const { data } = await api.post<Presentacion>(
    `/productos/${productoId}/presentaciones`,
    payload,
  );
  return data;
...
export async function actualizarPresentacion(
  ...
  const { data } = await api.put<Presentacion>(
    `/presentaciones/${id}`,
    payload,
  );
  return data;
...
export async function actualizarUnidad(
  ...
  const { data } = await api.put<UnidadBasica>(
    `/unidades-basicas/${id}`,
    payload,
  );
  return data;
...
export async function buscarGtinLookup(
  codigo: string,
): Promise<ScanLookupResponse> {
  const { data } = await api.get<ScanLookupResponse>("/productos/scan/lookup", {
    params: { codigo },
  });
  return data;
}
...
export async function aprobarProductoQuarantine(
  id: string,
  payload: ApproveProductPayload,
): Promise<ProductoDetalle> {
  const { data } = await api.post<ProductoDetalle>(
    `/productos/${id}/approve`,
    payload,
  );
  return data;
}
