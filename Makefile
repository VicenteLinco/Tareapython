...
test:
	...
	@bash source/tooling/test-isolated-db.sh --workdir source/backend -- cargo test --locked --test db_isolation_contract --test producto_lifecycle_contract --test package_identifier_contract --test inventory_ledger_contract --test readiness_policy_contract --test idempotency_audit_contract --test producto_api_contract --test package_offer_api_contract --test import_batch_contract --test common_api_contract --test receipt_atomic_contract --test scanner_session_contract --test migration_contract_test --test release_contract_test --test recepcion_y_guia_process_contract --test consumo_y_solicitud_process_contract --test smart_importer_process_contract --test edge_cases_process_contract -- --nocapture --test-threads=1

test-db:
	@bash source/tooling/test-isolated-db.sh --workdir source/backend -- cargo test --locked --test db_isolation_contract --test producto_lifecycle_contract --test package_identifier_contract --test inventory_ledger_contract --test readiness_policy_contract --test idempotency_audit_contract --test producto_api_contract --test package_offer_api_contract --test import_batch_contract --test common_api_contract --test receipt_atomic_contract --test scanner_session_contract --test recepcion_y_guia_process_contract --test consumo_y_solicitud_process_contract --test smart_importer_process_contract --test edge_cases_process_contract -- --nocapture --test-threads=1
