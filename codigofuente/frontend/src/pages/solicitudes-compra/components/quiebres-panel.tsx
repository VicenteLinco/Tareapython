...
function RecCard({
  ...
  const sugLabel = r.cantidad_sugerida_presentacion
    ...
    : formatCantidad(
        Math.ceil(sugBase),
        r.unidad_base,
        r.unidad_base_plural ?? undefined,
      );
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-1">
        ...
        {!alreadyAdded && <UrgenciaTag valor={r.nivel_urgencia} size="sm" />}
        {!alreadyAdded && (
      ...
      <div className="flex items-center justify-between">
        ...
        {yaPedido === 0 && (
          <p
            className="text-[9px] text-base-content/35 font-medium"
            title={r.razon ?? ""}
          >
            Sug: {sugLabel}
          </p>
      ...
      {yaPedido > 0 && (
        ...
        >
          ...
          <span className="tabular-nums">
            {Math.round(yaPedido)} {unidadEnCamino} en camino
          </span>
...
function GrupoQuiebres({
  ...
  const criticos = grupo.recs.filter(
    (r) => r.nivel_urgencia === "critica",
  ).length;
    ...
    <div className="rounded-2xl border border-base-200 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <span
            className={cn(
              "text-base-content/40 transition-transform text-xs",
              open ? "rotate-90" : "",
            )}
          >
            ›
            ...
            <div className="h-full flex flex-col items-center justify-center opacity-30 text-center p-6 gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] mt-0.5">
                  Sin quiebres para los proveedores seleccionados.
                </p>
              </div>
            </div>
          ) : (
